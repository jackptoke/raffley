defmodule RaffleyWeb.Router do
  ...
  def spy(conn, _opts) do
    greeting = ~w(Hi Howdy Hello สวัสดีครับ) |> Enum.random()
  ...
  scope "/", RaffleyWeb do
    ...
    live("/raffles", RafflesLive)
    live("/raffles/:id", RafflesLive.Show)
  end
  ...
  scope "/api", RaffleyWeb.Api do
    ...
    put "/raffles/:id", RaffleController, :update
    delete "/raffles/:id", RaffleController, :delete
  end
